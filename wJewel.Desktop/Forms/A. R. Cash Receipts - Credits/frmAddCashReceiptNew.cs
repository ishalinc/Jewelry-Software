...
{
    public partial class frmAddCashReceiptNew : Telerik.WinControls.UI.RadForm
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            // here we calculate total for app_amount to check debits match credits
            ...
            dtAddCashReceipt.Columns.Remove("RSORT");
            dtAddCashReceipt.Columns.Remove("IREFNO");
            dtAddCashReceipt.AcceptChanges();

            if (this.receiptService.SaveReceipt(dtAddCashReceipt, this.txtBillingAcctNo.Text, this.txtReceiptNo.Text, this.txtEntryDate.Value, this.txtDepositDate.Value, this.ddlBankAcc.Text, Convert.ToDecimal(this.txtCheckAmount.Value), Convert.ToDecimal(this.txtDiscountTaken.Value), this.chkShowMemo.Checked, out error))
            {
