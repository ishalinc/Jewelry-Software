...
{
    public partial class frmPrintAdjRcvable : Telerik.WinControls.UI.RadForm
    {
        ...
        public frmPrintAdjRcvable(string pinvno, List<KeyValuePair<string, string>> list)
        {
        ...
        private void PrintReport()
        {
            ...
            if (dvPayItems.Count > 0)
            {
                ...
                Helper.PrintReport(objReportPrinting, "Adj. Receipt Print", "IshalInc.wJewel.Desktop.Forms.Reports.rptAdjRcvable.rdlc", this.output_type, reportDataSourceCollection, reportParameterCollection, custemail);
