...
{
    public partial class frmDeductSalesmanInventory : Telerik.WinControls.UI.RadForm
    {
        ...
        public frmDeductSalesmanInventory()
        {
            InitializeComponent();
        }

        public frmDeductSalesmanInventory(string logno)
        {
            InitializeComponent();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (this.salesmenService.SaveInventory(dtSlsSamp, out error))
            {
                if (string.IsNullOrEmpty(error))
                    Helper.AddKeepRec("Deduct Salesman Log# " + this.txtLogNo.Text);
            }
            if (string.IsNullOrEmpty(error))
            {
                is_cancelled = false;
