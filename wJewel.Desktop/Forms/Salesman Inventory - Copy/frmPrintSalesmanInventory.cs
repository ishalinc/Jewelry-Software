        ...
        private void PrintReport()
        {
           ...
           if (string.IsNullOrEmpty(txtFromStyle.Text))
            ...
            if (dvSalesmanInv.Count > 0)
            {
                ...
                {
                    case "Preview":
                        objReportPrinting.PrintReport("Print Salesman Inventory", "IshalInc.wJewel.Desktop.Forms.Reports.rptSalesmanInvByLineAndStyle.rdlc", reportParameterCollection, reportDataSourceCollection, "Print Salesman Inventory");
                        break;
                    case "Print":
                        objReportPrinting.PrintReport("IshalInc.wJewel.Desktop.Forms.Reports.rptSalesmanInvByLineAndStyle.rdlc", reportParameterCollection, reportDataSourceCollection);
                        break;
                    case "Email":
                        objReportPrinting.SendasEmail("IshalInc.wJewel.Desktop.Forms.Reports.rptSalesmanInvByLineAndStyle.rdlc", reportParameterCollection, reportDataSourceCollection, custemail, string.Format("Print Salesman Inventory"));
                        break;
                }
            }
            else
