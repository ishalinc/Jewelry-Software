...
namespace IshalInc.wJewel.Data.DataModel
{
    public class InvoiceModel
    {
        ...
        public decimal? TERM9 { get; set; }

        public decimal? TERM_PCT9 { get; set; }

        public decimal? TERM10 { get; set; }

        public decimal? TERM_PCT10 { get; set; }

        public decimal? TERM11 { get; set; }

        public decimal? TERM_PCT11 { get; set; }

        public decimal? TERM12 { get; set; }

        public decimal? TERM_PCT12 { get; set; }
